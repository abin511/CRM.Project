...
-- --------------------------------------------------
-- Date Created: 06/23/2016 01:24:37
-- Generated from EDMX file: E:\Space.Work\CRM.Project\CRM.Core\CRM.Model\DataModel.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[GoodInfo]', 'U') IS NOT NULL
    DROP TABLE [dbo].[GoodInfo];
GO
IF OBJECT_ID(N'[dbo].[Property]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Property];
GO
IF OBJECT_ID(N'[dbo].[PropOption]', 'U') IS NOT NULL
    DROP TABLE [dbo].[PropOption];
GO
IF OBJECT_ID(N'[dbo].[GoodsPropValue]', 'U') IS NOT NULL
    DROP TABLE [dbo].[GoodsPropValue];
GO
IF OBJECT_ID(N'[dbo].[GoodSKU]', 'U') IS NOT NULL
    DROP TABLE [dbo].[GoodSKU];
GO
IF OBJECT_ID(N'[dbo].[ImageInfo]', 'U') IS NOT NULL
...
GO
IF OBJECT_ID(N'[dbo].[CategoryProperty]', 'U') IS NOT NULL
    DROP TABLE [dbo].[CategoryProperty];
GO
IF OBJECT_ID(N'[dbo].[PropertyGoodInfo]', 'U') IS NOT NULL
    DROP TABLE [dbo].[PropertyGoodInfo];
GO
IF OBJECT_ID(N'[dbo].[GoodSKUGoodsPropValue]', 'U') IS NOT NULL
    DROP TABLE [dbo].[GoodSKUGoodsPropValue];
GO
IF OBJECT_ID(N'[dbo].[CategoryGoodInfo]', 'U') IS NOT NULL
...
ADD CONSTRAINT [PK_ActionInfoActionGroup]
    PRIMARY KEY CLUSTERED ([ActionInfo_ID], [ActionGroup_ID] ASC);
GO
...
ADD CONSTRAINT [PK_ActionGroupRole]
    PRIMARY KEY CLUSTERED ([ActionGroup_ID], [Role_ID] ASC);
GO
...
ADD CONSTRAINT [PK_PropertyGoodInfo]
    PRIMARY KEY CLUSTERED ([Property_ID], [GoodInfo_ID] ASC);
GO
...
ADD CONSTRAINT [PK_GoodSKUGoodsPropValue]
    PRIMARY KEY CLUSTERED ([GoodSKU_ID], [GoodsPropValue_ID] ASC);
GO
...
ADD CONSTRAINT [PK_CategoryGoodInfo]
    PRIMARY KEY CLUSTERED ([Category_ID], [GoodInfo_ID] ASC);
GO
